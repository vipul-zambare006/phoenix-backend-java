...
public class User implements Cloneable, Serializable {
     ...
     * which is the primary key of the corresponding table. and Third constructor takes three arguments Id, name and roles array
     */
    public User() {
    ...
    public User(String idIn, String name, ArrayList<Role> roles) {
        this.id = idIn;
        this.name = name;
        this.roles = roles;
    }
